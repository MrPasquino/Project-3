...
length(lm(price ~ . + f.waterfront + f.floor + f.cond + f.renov + f.zipcode, data = train.culled)$coef)

library("leaps")


model.forward <- regsubsets(price ~ . + f.waterfront + f.floor + f.cond + f.renov + f.zipcode, data = train.culled, method = "forward", nvmax = 85)

model.backward <- regsubsets(price ~ . + f.waterfront + f.floor + f.cond + f.renov + f.zipcode, data = train.culled, method = "backward", nvmax = 85)
