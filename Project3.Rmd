...
```
James please check this answer.

The boxplots show that some zip codes have far higher house prices than most, notably 98004, 98039, and 98004, but based on these box plots alone we cannot determine whether or not it is good to include zip code dummy variables in the model, for these discrepancies in house prices could be due to confouonding variables. Further analysis is needed to determine whether we should use dummy variables.
